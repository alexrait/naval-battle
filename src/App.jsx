  ...
  return (
    <div className="ocean-bg relative min-h-screen w-full flex flex-col font-sans overflow-x-hidden text-slate-900">
      ...
      <main className="relative z-10 flex-1 w-full flex flex-col items-center justify-center p-6">
        {!user && gameState === "idle" && (
          <div className="w-full max-w-6xl flex flex-col items-center text-center fade-up gap-12">
            <div className="space-y-4">
               <div className="w-fit mx-auto px-6 py-2 rounded-full bg-blue-50 text-blue-600 text-[10px] font-black tracking-[0.3em] uppercase border border-blue-100">
                  Global Naval Command • Tactical Simulator
               </div>
               <h1 className="text-9xl md:text-[10rem] font-black text-blue-900 leading-[0.8] tracking-tighter tactical-font italic drop-shadow-sm">
                 IRON<span className="text-blue-600">&</span>TIDE
               </h1>
            </div>

            <div className="w-full max-w-md command-card rounded-[3rem] p-12 md:p-16 shadow-[0_32px_64px_-12px_rgba(29,78,216,0.3)] relative overflow-hidden text-white">
              ...
              <div className="space-y-6">
                <Button 
                  onClick={login} 
                  className="w-full rounded-2xl py-8 text-lg font-black bg-white text-blue-700 hover:bg-blue-50 hover:scale-[1.02] transition-all flex gap-4 shadow-xl border-none"
                >
                ...
                <div className="flex items-center gap-4 py-2">
                  ...
                  <span className="text-[10px] text-white/40 font-black tracking-widest uppercase">Encryption Active</span>
                  <div className="h-px flex-1 bg-white/20" />
                </div>
                ...
                <Button 
                  ...
                  className="w-full rounded-xl py-6 text-xs font-black tracking-[0.2em] text-white/70 hover:text-white hover:bg-white/10 uppercase"
                >
            ...
            <div className="flex gap-16 opacity-30 text-[10px] font-black uppercase tracking-[0.4em] tactical-font text-blue-900">
        ...
        {gameState === "idle" && user && (
          <div className="flex flex-col items-center gap-16 w-full max-w-4xl fade-up text-left">
            <div className="text-center space-y-6">
              <h2 className="text-7xl font-black text-blue-900 tactical-font tracking-tight uppercase">{t("inviteFriend")}</h2>
              <div className="flex items-center justify-center gap-6">
                 <div className="h-px w-16 bg-blue-200" />
                 <p className="text-blue-600 text-sm font-black uppercase tracking-[0.5em] italic">Scan for Rival Signal</p>
                 <div className="h-px w-16 bg-blue-200" />
              </div>
            </div>
            
            <div className="w-full bg-white border border-blue-100 rounded-[4rem] p-16 md:p-24 flex flex-col items-center gap-16 shadow-[0_40px_100px_-20px_rgba(29,78,216,0.15)]">
              <div className="h-32 w-32 bg-blue-50 rounded-full flex items-center justify-center border border-blue-100 shadow-inner">
                <Target className="text-blue-600 animate-pulse" size={64} />
              </div>
              
              <div className="flex flex-col gap-8 w-full max-w-md">
                <div className="space-y-4">
                  <label className="text-xs font-black uppercase tracking-[0.3em] text-slate-400 ml-1">Target Signature (Email)</label>
                  <div className="relative group">
                    ...
                    <Input 
                      ...
                      className="pl-16 h-20 rounded-2xl bg-slate-50 border-slate-100 focus:border-blue-200 focus:bg-white text-xl tactical-font shadow-inner text-slate-900 placeholder:text-slate-300"
                      value={targetEmail}
                ...
                <Button 
                  onClick={sendInvite} 
                  className="w-full h-20 rounded-2xl text-2xl font-black tactical-font bg-blue-600 hover:bg-blue-500 shadow-xl shadow-blue-600/20 uppercase tracking-widest text-white"
                >
                  {t("send")}
                </Button>
              </div>
      ...
      <footer className="relative z-10 w-full p-12 text-center border-t border-blue-50 bg-white/50 backdrop-blur-sm">
        <p className="text-[10px] text-blue-900/20 font-black uppercase tracking-[1em] tactical-font">
